...
This kit is designed for anyone who wants to help create any kind of Python-focused meetup. This can mean anything, from a small informal social gathering to a big conference - see the [Event MVP](event-mvp/index.md) section for more examples. A lot of this advice works for any kind of event.
